...
class RedisTemplateTest {
    ...
    public void string_test() {
        ...
        stringStringValueOperations.set(key, "5");

        final String result03 = stringStringValueOperations.get(key);
        Assertions.assertThat(result03).isEqualTo("5");
    }
    ...
    public void list_test() {
        ...
        stringStringListOperations.rightPushAll(key, " ", "j", "i", "s", "m", "!");
        ...
        Assertions.assertThat(resultString).isEqualTo(Arrays.asList(new String[]{"H", "i", " ", "j", "i", "s", "m", "!"}));
    }
    ...
    public void set_test() {
        ...
        Assertions.assertThat(members.toArray()).isEqualTo(new String[]{"H", "i"});
        ...
        Assertions.assertThat(sb.toString()).isEqualTo("Hi");
    }
